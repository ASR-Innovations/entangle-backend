...
class OrderFulfillmentMonitorService {
  constructor() {
    ...
    this.seaportContractAddress = process.env.SEAPORT_CONTRACT_ADDRESS || '0x0000000000000068F116a894984e2DB1123eB395'; // Seaport 1.6 on Sepolia
    this.chainId = parseInt(process.env.SEAPORT_CHAIN_ID || '11155111'); // Sepolia chain ID
    this.rpcUrl = process.env.RPC_URL || process.env.AVALANCHE_RPC || 'https://ethereum-sepolia-rpc.publicnode.com';
    this.wsRpcUrl = process.env.WS_RPC_URL || 'wss://ethereum-sepolia-rpc.publicnode.com';
